...
#   filename:  https://raw.githubusercontent.com/sonallux/spotify-web-api/main/fixed-spotify-open-api.yml
#   timestamp: 2022-04-14T17:26:16+00:00
...
class DeviceObject(BaseModel):
    ...
    name: Optional[str] = Field(
        None, description="The name of the device.", example="Loudest speaker"
    )
...
class CursorPagingObject(BaseModel):
    ...
    items: Optional[List[Dict[str, Any]]] = Field(
        None, description="The requested data."
    )
...
class PagingObject(BaseModel):
    ...
    items: List[Dict[str, Any]] = Field(..., description="The requested content\n")
    limit: int = Field(
        ...,
        description="The maximum number of items in the response (as set in the query or by default).\n",
        example=20,
...
class ReleaseDatePrecision1(Enum):
    year = "year"
    month = "month"
    day = "day"
...
class EpisodeBase(BaseModel):
    ...
    type: Type5 = Field(..., description="The object type.\n")
    uri: str = Field(
        ...,
...
class AlbumBase(BaseModel):
    ...
    release_date_precision: ReleaseDatePrecision1 = Field(
        ...,
        description="The precision with which `release_date` value is known.\n",
        example="year",
    )
...
class ShowsPagingObject(PagingObject):
    items: Optional[List[SimplifiedShowObject]] = None


class SimplifiedArtistsPagingObject(PagingObject):
    items: Optional[List[SimplifiedArtistObject]] = None


class SimplifiedTracksPagingObject(PagingObject):
    items: Optional[List[SimplifiedTrackObject]] = None


class PlayHistoryObject(BaseModel):
    track: Optional[SimplifiedTrackObject] = Field(
...
class AlbumObject(AlbumBase):
    ...
    tracks: Optional[SimplifiedTracksPagingObject] = Field(
...
class EpisodesPagingObject(PagingObject):
...
class PlaylistTrackObject(BaseModel):
    ...
    track: Optional[Union[TrackObject, EpisodeObject]] = Field(
        None, description="Information about the track or episode."
    )
...
class CurrentlyPlayingObject(BaseModel):
    ...
    item: Optional[Union[TrackObject, EpisodeObject]] = Field(
        None, description="The currently playing track or episode. Can be `null`."
    )
...
class CurrentlyPlayingContextObject(BaseModel):
    ...
    shuffle_state: Optional[str] = Field(None, description="If shuffle is on or off.")
    context: Optional[ContextObject] = Field(
        None, description="A Context Object. Can be `null`."
    )
    timestamp: Optional[int] = Field(
...
class ShowObject(ShowBase):
    episodes: EpisodesPagingObject = Field(
        ..., description="The episodes of the show.\n"
    )


class PlaylistTracksPagingObject(PagingObject):
...
class PlaylistObject(BaseModel):
    ...
    tracks: Optional[PlaylistTracksPagingObject] = Field(
